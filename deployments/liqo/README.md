...
| networking.clientResources | list | `[{"apiVersion":"networking.liqo.io/v1beta1","resource":"wggatewayclients"},{"apiVersion":"networking.liqo.io/v1beta1","resource":"vxlangatewayclients"}]` | Set the list of resources that implement the GatewayClient |
...
| networking.serverResources | list | `[{"apiVersion":"networking.liqo.io/v1beta1","resource":"wggatewayservers"},{"apiVersion":"networking.liqo.io/v1beta1","resource":"vxlangatewayservers"}]` | Set the list of resources that implement the GatewayServer |
